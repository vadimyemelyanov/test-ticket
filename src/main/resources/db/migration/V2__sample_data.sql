...
insert into chats (uuid, name, product, telegram_link, created_at, updated_at, current_state, last_message,
...
values ('f596c437-f529-4128-8707-4553ef80c2c0', 'test', 'GAD', 'http://tlg.me', '2022-12-03 01:26:45',
        '2022-12-03 00:26:58', 'QUALIFICATION', 'Hola my friend, i want some drugs', 'testerss', '',
        '2022-12-03 09:06:34'),
...
insert into db.state_history (uuid, state, chat_uuid, to_date, from_date)
...
insert into notes (uuid, text, chat_uuid, created_at, updated_at)
