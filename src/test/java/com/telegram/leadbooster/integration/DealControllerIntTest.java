...
import static com.telegram.leadbooster.utils.TestUtils.getFileContent;
...
public class DealControllerIntTest {
    ...
    public void shouldMoveDealToNewStatus() {
        //given
        MoveDealRequest moveDealRequest = new MoveDealRequest(DealState.KYC);
        //when
        mockMvc
    ...
    public void shouldFailOnMovingCauseWrongCurrentState() {
        //given
        MoveDealRequest moveDealRequest = new MoveDealRequest(DealState.CLOSED);
        //when
        mockMvc
            .perform(MockMvcRequestBuilders
                .patch("/api/v1/deals/" + DEAL_UUID + "/move")
